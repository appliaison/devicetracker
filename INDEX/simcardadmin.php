...
?>
  ...
  <td align="center" class="tabs" colspan="2">
			...
			<td class="tabup"><a href="simcardadmin.php" class="plain">SIM card admin</a></td>
...
<?
$sql = "SELECT * FROM settings WHERE settings_device = 'sim'";
...
while ($fetch = mysql_fetch_assoc($rs))
{
	...
	<td>
	<select name="settings_val<?=$fetch['settings_id']?>" class="list" id="settings_val<?=$fetch['settings_id']?>" onchange="sim_save_settings_sendrequest(<?=$fetch['settings_id']?>); return false;">
