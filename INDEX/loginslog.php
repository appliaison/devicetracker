...
?>
            ...
            <tr id="nav-secondary">
                <td align="center" class="tabs" colspan="2">
                    ...
                    <table cellpadding="0" cellspacing="0" align="center"><tr>
                            <td class="tabup"><a href="loginslog.php" class="plain">Loginslog</a></td>
	...
	?>
        <form action="index.php" method="post" name="longform" onsubmit="return verify('Are you sure?')"><table cellpadding="0" cellspacing="0" border="0" id="list" align="center">
                <tr>
                    ...
                    <th><a href="index.php?step=list&#38;event=admin&#38;sort=privs&#38;dir=desc">Date</a></th>
                    <th><a href="index.php?step=list&#38;event=admin&#38;sort=last_login&#38;dir=desc">Time</a></th><th>&#160;</th><th>&#160;</th></tr>
                <?php
                $sql = "SELECT ll.loginlog_id AS loginlog_id, u.username AS username, ll.time AS time, ll.date AS date, ll.coordinates AS coordinates "
                    .	" FROM troubador_device.loginlog AS ll LEFT JOIN users AS u ON u.Id = ll.userid ORDER BY loginlog_id DESC LIMIT 0, 1000";
                $rs = mysql_query($sql, $connect);
                while ($fetch = mysql_fetch_assoc($rs) ) {
                    ?>
                <tr>
                    <td><?=$fetch['loginlog_id']?></td>
                    <td>&nbsp;</td>
