...
?>
		...
		if (isset($type))
		{
			...
			$sqltypes = "SELECT * FROM troubador_device.handheld_type ORDER BY Id";
			...
			for ($icount=0; $icount<sizeof($typesarray); $icount++)
			{
				...
				. " WHERE (1=1) AND h.type='$typesvalue' " ;
		...
		if (isset($type))
		{
							...
							for ($icount=0; $icount<sizeof($typesarray); $icount++)
							{
                                ...
                                if ($num_results>0)
								{
									...
									<?if ($_SESSION['hh_settings']['hh_show_assigned_num']) { echo '<th class="asc"><label>Asg</label></th>'; } ?>
									<? if ($_SESSION['hh_settings']['hh_show_revision_num']) { echo '<th><label>Rev#</label></th>'; } ?>
									<? if ($_SESSION['hh_settings']['hh_show_pin']) { echo '<th><a href="index.php?step=list&#38;event=admin&#38;sort=last_login&#38;dir=desc">PIN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></th>'; } ?>
									<? if ($_SESSION['hh_settings']['hh_show_imei']) { echo '<th class="col_imei"><a href="index.php?step=list&#38;event=admin&#38;sort=last_login&#38;dir=desc">IMEI/MEID</a></th>'; } ?>
									...
									{ 
									echo '<img src="iconimages/available.gif" alt="Available" title="Available">';
									} 
									?>
