...
while ($fetch = mysql_fetch_assoc($rs) ) 
{
	...
	if (strlen($Assigned_To) > 0)
	{
		...
		echo $sql3 = "UPDATE devicetracker.simcards SET user_id = $userid WHERE ICCID = '$iccid'" ;
	...
	else
	{
		...
		echo $sql4 = "UPDATE devicetracker.simcards SET user_id = 11 WHERE ICCID = '$iccid'";
	...
	if (strlen($Owner_Name) > 0) 
	{
		...
		echo $sql6 = "UPDATE devicetracker.simcards SET owner_id = $ownerid WHERE ICCID = '$iccid'" ;
