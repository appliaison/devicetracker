...
$sqlcheckpermissions = "SELECT isadmin, email FROM users WHERE email = '$useremail' AND isactive=1";
$rs = mysql_query($sqlcheckpermissions, $connect);
$fetch = mysql_fetch_assoc($rs);

if  ( (!$fetch['isadmin']) and ($_SERVER['PHP_SELF'] != '/devicetracker/index.php') and ($_SERVER['PHP_SELF'] != '/devicetracker/imsearchsim-run.php')  )
{
echo "<br/>";
