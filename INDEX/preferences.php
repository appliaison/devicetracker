...
-->
  ...
  <td align="center" class="tabs" colspan="2">
			...
			<td class="tabup"><a href="?event=prefs" class="plain">Preferences</a></td>
			<td class="tabdown2"><a href="users.php" class="plain">Users</a></td>
			<td class="tabdown2"><a href="addhh.php" class="plain">Add Handheld</a></td>
			<td class="tabdown2"><a href="addsimcard.php" class="plain">Add SIM card</a></td><td class="tabdown2">
			<a href="?event=export" class="plain">Export to Excel</a></td></tr></table></td></tr></table>
