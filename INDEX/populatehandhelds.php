...
echo 'This script takes the "handhelds" table from the hhdb2.handhelds table and populates the "handhelds22" '
...
$sql_num_rows_in_handhelds = "SELECT * FROM hhdb2.handhelds";
$rs_num_rows_in_handhelds = mysql_query($sql_num_rows_in_handhelds , $connect);
$num_rows_in_handhelds = mysql_num_rows($rs_num_rows_in_handhelds);

$select2 = mysql_select_db('devicetracker');

$sql_num_rows_in_handhelds22 = "SELECT * FROM troubador_device.handhelds22";
$rs_num_rows_in_handhelds22 = mysql_query($sql_num_rows_in_handhelds22, $connect);
$num_rows_in_handhelds22 = mysql_num_rows($rs_num_rows_in_handhelds22);

echo "The number of rows in the hhdb2.handhelds table is : " . $num_rows_in_handhelds;

echo "<br>";

echo "The number of rows in the devicetracker.hanhelds22 table is : " . $num_rows_in_handhelds22;

if ( $num_rows_in_handhelds22 == $num_rows_in_handhelds)
{
	exit();
}
