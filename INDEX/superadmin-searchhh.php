...
?>
            ...
            <tr id="nav-secondary">
                <td align="center" class="tabs" colspan="2">
                    ...
                    <table cellpadding="0" cellspacing="0" align="center"><tr>
                                   <td class="tabup"><a href="superadmin-searchhh.php" class="plain">Search HH</a></td>
									<td class="tabdown"><a href="findcorps.php" class="plain">Find Corporates</a></td>
		...
		?>
        <?
        require "superadmin-searchhh-constructsearchform.php";
        ?>
        <div class="content"  >
            ...
            {
                require "superadmin-searchhh-displayhandheld.php";
             ...
             if (isset($_REQUEST['type']))
            {
                ...
                if (strlen($_REQUEST['type']) > 0 )
                {
                    ...
                    require "superadmin-searchhh-server.php";
