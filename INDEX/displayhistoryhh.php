            ...
            <tr id="nav-secondary">
                <td align="center" class="tabs" colspan="2">
                    ...
                    <table cellpadding="0" cellspacing="0" align="center"><tr>
                            ...
                            <td class="tabup"><a href="displayhistoryhh.php" class="plain">History</a></td>
...
$sql = "SELECT u.username AS username, u.email, h.userid, h.adminid AS admin, h.hhID, h.action, h.date AS thetime FROM troubador_device.history AS h LEFT JOIN devicetracker.users AS u ON h.adminid = u.Id WHERE h.hhid <> 0 ORDER BY h.date DESC, h.id DESC LIMIT 0, 500";
