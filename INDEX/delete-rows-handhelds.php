...
require 'db.php';
	...
	$dropsql = "DELETE FROM handhelds22";
	$rs = mysql_query($dropsql, $connect) or die(mysql_error());
	if ($rs)
	{
		echo "The handhelds table was flushed";
	}
	else 
	{
		echo "Trouble flushing handhelds table";
	}
		
	
?>
<p id="moniker"><a href="index.php?logout=1">Logout</a></p>
<br />
<a href="statuses.php">Return to status page</a></p>
